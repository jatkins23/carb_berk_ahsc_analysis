...
# Functions to be used in the modeling functions


## (func-def) Tidy Tobit Model
This function takes in an output object from the `AER::tobit` function and returns it as a tidy-table of all the necessary 
