...
library(fastDummies)
# dummify
df.modeling31.dummies <- fastDummies::dummy_cols(df.modeling31.scaled, remove_selected_columns = TRUE, remove_most_frequent_dummy = FALSE)
...
# Model
model.31 <- AER::tobit(form.31, left=0, data=df.modeling31.dummies)
